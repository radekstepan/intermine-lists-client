...
(function() {
  ...
  App.Views.SidebarFolderCollectionView = (function(_super) {

    __extends(SidebarFolderCollectionView, _super);

    function SidebarFolderCollectionView() {
      this.addOneFolder = __bind(this.addOneFolder, this);
      return SidebarFolderCollectionView.__super__.constructor.apply(this, arguments);
    }
    ...
    SidebarFolderCollectionView.prototype.deselectOtherLists = function(listSlug) {
      return _.each(App.Models.Lists.selected(), (function(list) {
        if (list.get("slug") !== listSlug) {
          return list.set({
            selected: false
          });
        }
